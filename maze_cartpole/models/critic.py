"""Contains custom critic (value) networks"""
...
class CartPoleStateValueNet(nn.Module):
    ...
    def __init__(self, obs_shapes: dict[str, Sequence[int]], non_lin: str | type(nn.Module)):
        ...
        self.perception_dict['concat'] = ConcatenationBlock(
            ...
            out_keys='concat',
            in_shapes=[
                obs_shapes['cart_position'],
                obs_shapes['cart_velocity'],
                obs_shapes['pole_angle'],
                obs_shapes['pole_angular_velocity'],
            ],
            concat_dim=-1,
        )
        ...
        self.perception_net = InferenceBlock(
            ...
            out_keys='value',
            in_shapes=[
                obs_shapes[key] for key in ['cart_position', 'cart_velocity', 'pole_angle', 'pole_angular_velocity']
            ],
