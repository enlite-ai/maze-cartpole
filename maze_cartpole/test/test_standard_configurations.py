...
configurations = [
    [
        'conf_train',
        {
            'algorithm': 'ppo',
            'env': 'cartpole_env',
            'seeding.agent_base_seed': 2079466554,
    ...
    [
        ...
        {
            'algorithm': 'ppo',
            'model': 'cartpole_custom_model',
            'critic': 'cartpole_custom_state_critic',
            'env': 'cartpole_env',
            'seeding.agent_base_seed': 2079466554,
            'seeding.env_base_seed': 698376768,
            'runner': 'dev',
